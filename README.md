...
`Python` `Flask` `NLP` `React.js` `MongoDB` `REST APIs` `Power BI` `Agile/Scrum` `Git`
...
```yaml
Learning:
  - Advanced LLM Engineering & RAG
  - System Design
  - Multi-Agent Architectures
  - Production GenAI Patterns

Building:
  - FemSafe AI Agent Pipeline
...
Open_To:
  ...
  - Pune / India-Based Opportunities
```
